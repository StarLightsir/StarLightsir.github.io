<template>
  ...
  <table width="100%" border="0"  align="center" cellpadding="3" cellspacing="1" class="newsline">
								<tr>
        <td width='22%' height=44>帐号：</td><td width='39%' >{{chuangzuozhedetail.zhanghao}}</td></tr><tr>         <td width='22%' height=44>密码：</td><td width='39%'>******</td></tr><tr>         <td width='22%' height=44>姓名：</td><td width='39%' >{{chuangzuozhedetail.xingming}}</td></tr><tr>         <td width='22%' height=44>性别：</td><td width='39%'><div v-if="chuangzuozhedetail.xingbie==1">男</div><div v-else>女</div></td></tr><tr>         <td width='22%' height=44>身份证：</td><td width='39%'>******</td></tr><tr>         <td width='22%' height=44>联系电话：</td><td width='39%' >{{chuangzuozhedetail.lianxidianhua}}</td></tr><tr>                  
</table>
        <div class="button">
		  <!--dshoucang1-->
